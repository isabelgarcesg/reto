  ...
  <div>
    <nav class="navbar navbar-expand navbar-light bg-light">
      <div class="nav navbar-nav">
        ...
        style="margin-left: 600px;"><span class="material-icons text-muted" style="font-size: 24px;">add_box</span></router-link>
      </div>
    </nav>
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                      ...
                      <li>
                        <button type="button" class="dropdown-item" data-bs-toggle="modal"
                          data-bs-target="#staticBackdrop" v-on:click="servicioSeleccionado = servicio">
                          Borrar
                        </button>
                      </li>
                    </ul>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" v-on:click="borrarServicio(servicioSeleccionado.id)" class="btn btn-primary">Entendido</button>
        </div>
      </div>
    </div>
  </div>
