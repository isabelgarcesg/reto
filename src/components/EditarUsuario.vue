            ...
            <div class="card-body">
                <form v-on:submit.prevent="edicionUsuarios">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text"
                        class="form-control" name="doc" v-model="usuario.doc" id="doc" aria-describedby="helpId" placeholder="ID">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text"
                        class="form-control" name="name" v-model="usuario.name"  id="name" aria-describedby="helpId" placeholder="Nombre">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text"
                        class="form-control" name="phone"  v-model="usuario.phone" id="phone" aria-describedby="helpId" placeholder="Número de celular">
                    ...
                    <div class="form-group">
                      ...
                      <input type="password"
                        class="form-control" name="password"  v-model="usuario.password" id="password" aria-describedby="helpId" placeholder="******">
...
export default {
    ...
    methods:{
        edicionUsuarios(){
            ...
            fetch('https://redb.qsystems.co/QS3100/QServlet?operation='+operation+'&tna='+tna+'&userId='+userId+'&nameUser='+nameUser+'&phoneUser='+phoneUser+'&passwordUser='+passwordUser+'&documentUser='+documentUser+'&positionUser='+positionUser+'&userType= int'+UserType+'&userEntityId='+userEntityId+'&key='+key)
